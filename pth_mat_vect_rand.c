 ...
 * 8Mx8    1.07e+00s| 1.07e+00|  5.4e-01|   5.8e-01|  2.77e-01|   6.97e-01 
 * 8kx8k   9.92e-01s| 9.87e-01|  4.9e-01|   5.04e-01| 2.52e-01|   3.55e-01
 * 8x8M    1.28e+00s| 1.3e+00|   8.62e-01|  1.37e+00| 3.003e+00|  2.99e+00
 *
 * On one thread, Block and cyclic pretty much have the same run times.
 * On two threads, Block and cyclic also seem to have similar speeds
 * On four threads, Block seems to be a little faster than cyclical because cyclical
 * has more misses than the block distribution. The block distribution gets more hits.
 */
...
void *Pth_mat_vect(void* rank) {
   ...
   int j; 
/*
* distributes by cyclical instead of block distribution
* i +=thread_count increments by a factor of thread_count
* i = my_rank so that the loop starts at my rank and increments at thread_count
*/
